...
const Terms =()=>{
    return (
      <>
        ...
        <p>Welcome to swiftlybox.com!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Swiftly Box {"Inc"} Website, located at
          https://swiftlybox.com/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use swiftlybox.com if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing swiftlybox.com, you agreed
          to use cookies in agreement with the Swiftly Box {"Inc"} Privacy
          Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Swiftly Box Inc and/or its licensors
          own the intellectual property rights for all material on
          swiftlybox.com. All intellectual property rights are reserved. You may
          access this from swiftlybox.com for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from swiftlybox.com</li>
          <li>Sell, rent or sub-license material from swiftlybox.com</li>
          <li>Reproduce, duplicate or copy material from swiftlybox.com</li>
          <li>Redistribute content from swiftlybox.com</li>
        </ul>
        ...
        <p>
          ...
          Swiftly Box Inc does not filter, edit, publish or review
          Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of Swiftly Box Inc,its agents
          ...
          applicable laws, Swiftly Box Inc shall not be liable for the
        ...
        <p>
          Swiftly Box Inc reserves the right to monitor all Comments and
        ...
        <p>
          You hereby grant Swiftly Box Inc a non-exclusive license to
        ...
        <p>
          ...
          the hyperlink compensates the absence of Swiftly Box Inc; and
        ...
        <p>
          ...
          sending an e-mail to Swiftly Box Inc. Please include your name,
        ...
        <p>
          No use of Swiftly Box {"Inc"} logo or other artwork will be
